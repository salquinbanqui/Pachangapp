...
public class Quiz2 implements ActionListener{
	...
	String[] questions = 	{
								...
								"De estos equipos, ¿en cuál jugó Maradona?",

								"Qué selección tiene más mundiales",

								"Con qué equipo ganó Maradona la Liga italiana",

								"Qué organismo rige el fútbol europeo profesional"

							};

	String[][] options = 	{

								{"Sevilla","Real Madrid","Milan","Barcelona"},

								{"Italia","Brasil","Bulgaria","Alemania"},

								{"Betis","Inter de Milán","Nápoles","Juventus de Turín"},

								{"AFC","FIFA","UEFA","Todas las anteriores"}
